...
public class Tank {
    ...
    public Tank(String brand, String model, int weight, int barrelCaliber, int amor) {
    ...
    public String toString() {
        return String.format("Brand: %s, Model: %s, Weight: %skg, Barrel caliber: %smm, Armor: %smm%n",
